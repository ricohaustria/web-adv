...
var FoodService = /** @class */ (function () {
    function FoodService(url) {
        this.url = url;
    }
    FoodService.prototype.log = function () {
        console.log('hello word logged from util');
    };
    FoodService.prototype.getFoodFetch = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, fetch(this.url).then(function (resp) { return resp.json(); })];
            });
        });
    };
    FoodService.prototype.getFood = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, axios_1.default.get(this.url)];
            });
        });
    };
    FoodService.prototype.addFood = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, axios_1.default.post(this.url, item)];
            });
        });
    };
    return FoodService;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var food_service_1 = __webpack_require__(/*! ./food-service */ "./src/food-service.ts");
var car_1 = __webpack_require__(/*! ./car */ "./src/car.ts");
console.log("Manually init util");
var util = new food_service_1.FoodService('http://localhost:3000/food');
util.log();
util.getFoodFetch().then(function (data) { return console.log("current food: " + data); });
console.log("Init State");
var food = { name: 'Langos' };
util.addFood(food).then(function (resp) { return console.log('new food added:', resp); });
function driveCar() {
